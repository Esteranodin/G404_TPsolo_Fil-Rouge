...
<section>
        <form class="relative w-[88%] mx-auto">
            <input type="search" id="searchBar"
                class="w-full shadow-lg p-4 ps-6 font-semibold text-paragraph placeholder-primary-grey border-primary-grey rounded-3xl bg-primary-grey/15"
                placeholder="Chercher un livre, un auteur..." required />

            <button type="submit" class="text-primary-grey absolute end-2.5 bottom-1.5 bg-primary-grey/25 hover:bg-neutral-grey-off focus:ring-2 focus:outline-none focus:ring-primary-pink font-medium rounded-full text-sm p-3 item-center box-content">
